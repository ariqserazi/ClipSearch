...
class DashboardFastModeTests(unittest.TestCase):
    def test_dashboard_defaults_to_fast_collection_mode(self):
        ...
        self.assertIn('id="research-pinterest"', html)
        self.assertIn('postJson("/research/pinterest-images", { query, limit })', html)
        self.assertIn("function renderPinterestResult(data)", html)
